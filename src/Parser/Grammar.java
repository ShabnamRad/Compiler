...
//        productions[0] = new Production(nonTerminals[0], new Token[]{nonTerminals[1], new Token("\uFFFF")});
//        productions[0] = new Production(nonTerminals[1], new Token[]{nonTerminals[2], nonTerminals[1]});
//        productions[0] = new Production(nonTerminals[1], new Token[]{new Token("", "epsilon", "special")});
        ...
        productions.add(new Production(nonTerminals[2], new Token[] {new Token("", "epsilon", "special")}));
        ...
        productions.add(new Production(nonTerminals[3], new Token[] {new Token("", "epsilon", "special")}));
    ...
    private HashSet<Token> first(Token token) {
       ...
       for(Production production :tokenProductions) {
           if(production.definitions.length == 1 && production.definitions[0].getTokenName().equals("epsilon"))
               res.add(new Token("", "epsilon", "special"));
           int index = 0;
           HashSet<Token> firstOfDef = first(production.definitions[index]);
           while(firstOfDef.contains(new Token("", "epsilon", "special"))) {
               firstOfDef.remove(new Token("", "epsilon", "special"));
